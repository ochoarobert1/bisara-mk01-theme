...
add_action( 'after_setup_theme', 'bisara_woocommerce_support' );
function bisara_woocommerce_support() {
...
add_action('woocommerce_before_main_content', 'bisara_woocommerce_custom_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'bisara_woocommerce_custom_wrapper_end', 10);

function bisara_woocommerce_custom_wrapper_start() {
...
function bisara_woocommerce_custom_wrapper_end() {
