<?php
add_action( 'tgmpa_register', 'bisara_register_required_plugins' );
 ...
 */
function bisara_register_required_plugins() {
    /*
     ...
     */
    $config = array(
        'id'           => 'bisara_tgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
